...
internal class ClientConnectionTransportFactory : IClientConnectionTransportFactory
{
    private readonly HubConfiguration _configuration;

    /// <summary>
    /// This class is seperated from <see cref="ClientConnectionManager"/>
    /// We use that logger to avoid making breaking changes.
    /// </summary>
    private readonly ILogger<ClientConnectionManager> _logger;

    public ClientConnectionTransportFactory(HubConfiguration configuration, ILogger<ClientConnectionManager> logger)
    {
