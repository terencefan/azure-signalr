...
public class MicrosoftEntraAccessKeyTests
{
    ...
    public async Task TestInitializeFailed()
    {
        ...
        var exception = await Assert.ThrowsAsync<AzureSignalRAccessKeyNotAvailableException>(
    ...
    [Theory]
    [InlineData(Constants.IngressDenied, "nginx")]
    [InlineData(Constants.RuntimeDenied, "http")]
